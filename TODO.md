...
TODO: Allow user to change add their pronouns, birthday and other information in profile and then update to the backend using update endpoint (Anotida)
- Also improve UI
TODO: Replace mock invite code and roomate data with real data
TODO: Implement notifications
TODO: Allow for users to delete their account or delete their household
