      ...
      <div className="max-w-md w-full">
        <div className="bg-white/60 backdrop-blur-md rounded-3xl shadow-2xl p-8 border border-purple-100/50">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-purple-700 mb-2">
              Chore, I'll do it!
            </h1>
          ...
          <div className="space-y-4">
            <div>
              <label className="text-purple-600 text-sm mb-2 block">Email</label>
              <Input 
                type="email" 
            ...
            <div>
              <label className="text-purple-600 text-sm mb-2 block">Password</label>
              <Input 
                type="password" 
                placeholder="••••••••"
                className="bg-white/80 border-purple-200 rounded-2xl"
