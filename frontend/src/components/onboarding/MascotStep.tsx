...
export function MascotStep({ onNext }: MascotStepProps) {
  ...
  return (
    <div className="bg-white/60 backdrop-blur-md rounded-3xl shadow-2xl p-12 border border-purple-100/50">
      ...
      {selectedMascot && (
        <div className="text-center mb-8">
          <div className="inline-block bg-gradient-to-br from-purple-50 to-pink-50 p-8 rounded-3xl shadow-lg border-2 border-purple-200">
            <MascotIllustration mascot={selectedMascot} color={selectedColor} size={120} showSparkle />
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-3 gap-4">
          {mascots.map(mascot => (
            ...
            >
              <MascotIllustration mascot={mascot.type} color={selectedColor} size={60} />
              <p className={`mt-3 text-sm ${
                selectedMascot === mascot.type ? 'text-purple-700' : 'text-purple-600'
              }`}>
                {mascot.name}
              </p>
            </button>
      ...
      {selectedMascot && (
        <div className="mb-8">
          <h3 className="text-purple-600 mb-4 text-center">Choose Your Color</h3>
