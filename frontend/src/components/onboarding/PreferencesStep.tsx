...
export function PreferencesStep({ chores, onNext }: PreferencesStepProps) {
  ...
  return (
    <div className="bg-white/60 backdrop-blur-md rounded-3xl shadow-2xl p-12 border border-purple-100/50 max-h-[80vh] overflow-y-auto">
              ...
              <div className="flex gap-2">
                ...
                >
                  <Heart className={`w-5 h-5 ${
                    preferences[chore] === 'love' ? 'text-red-600 fill-red-600' : 'text-pink-400'
                  }`} />
                </button>
                ...
                >
                  <Meh className={`w-5 h-5 ${
                    preferences[chore] === 'neutral' ? 'text-yellow-700' : 'text-yellow-400'
                  }`} />
                </button>
                ...
                >
                  <X className={`w-5 h-5 ${
                    preferences[chore] === 'avoid' ? 'text-gray-700' : 'text-gray-400'
                  }`} />
                </button>
              </div>
            </div>
      ...
      <Button
        ...
        className="w-full bg-gradient-to-r from-purple-400 to-pink-400 hover:from-purple-500 hover:to-pink-500 text-white rounded-2xl py-6"
      >
